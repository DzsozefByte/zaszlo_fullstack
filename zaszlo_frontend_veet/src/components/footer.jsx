    ...
    <footer className="bg-dark text-light pt-5 pb-4 mt-auto">
      <div className="container">
        <div className="row g-4">
          <div className="col-lg-4 col-md-6">
            ...
            <p className="text-secondary small">
              Magyarország legnagyobb zászló webshopja. Prémium minőség, egyedi méretek és
          ...
          <div className="col-lg-2 col-md-3 col-6">
            ...
            <ul className="list-unstyled text-secondary small">
              <li className="mb-2">
                <Link to="/kereso" className="text-decoration-none text-secondary hover-white">
                  Termékek
                </Link>
              </li>
            </ul>
          ...
          <div className="col-lg-2 col-md-3 col-6">
            ...
            <ul className="list-unstyled text-secondary small">
              <li className="mb-2">
                <Link to="/rolunk" className="text-decoration-none text-secondary hover-white">
                  Rólunk
                </Link>
              </li>
              <li className="mb-2">
                <Link to="/aszf" className="text-decoration-none text-secondary hover-white">
                  ÁSZF
                </Link>
              </li>
            </ul>
          ...
          <div className="col-lg-4 col-md-12">
            ...
            <div className="d-flex gap-3 mt-3">
              <a href="#" className="text-light social-icon" aria-label="Facebook">
                <FaFacebook size={20} />
              </a>
              <a href="#" className="text-light social-icon" aria-label="Instagram">
                <FaInstagram size={20} />
              </a>
              <a href="#" className="text-light social-icon" aria-label="Twitter">
                <FaTwitter size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center small text-secondary">
          ...
          <div className="mt-2 mt-md-0">Created with love in Hungary.</div>
        </div>
      </div>
      <style>{`
